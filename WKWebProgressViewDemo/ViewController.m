...
- (WKWebView *)wkWebView {
    if (!_wkWebView) {
        _wkWebView = [[WKWebView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight  - 40) configuration:self.wkConfig];
...
- (void)startLoad {
    NSString *urlString = @"http://novel.eyassx.com";
